...
const MeetingTypeList = () => {
  ...
  const [meetingState, setMeetingState] = useState<
    "isScheduledMeeting" | "isInstantMeeting" | "isJoiningMeeting" | undefined
  >();
  ...
  return (
    <section className={"grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4"}>
      ...
      <HomeCard
        ...
        className="bg-[var(--color-blue-1)]"
        handleClick={() => setMeetingState("isJoiningMeeting")}
      />
      <HomeCard
        img={"/icons/schedule.svg"}
        title={"Schedule meeting"}
        description={"Add your meeting"}
        handleClick={() => {
      ...
      >
        <Input
          ...
          className="border-none bg-[var(--color-dark-3)] focus-visible:ring-0 focus-visible:ring-offset-0"
          onChange={(e) => {
